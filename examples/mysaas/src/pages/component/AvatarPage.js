              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex items-center justify-center bg-gray-100 rounded-full w-6 h-6 text-[10px] font-semibold uppercase text-gray-500">
                        MS
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex items-center justify-center bg-gray-100 rounded-full w-7 h-7 text-[10px] font-semibold uppercase text-gray-500">
                        MS
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex items-center justify-center bg-gray-100 rounded-full w-8 h-8 text-xs font-semibold uppercase text-gray-500">
                        MS
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex items-center justify-center bg-gray-100 rounded-full w-10 h-10 text-sm font-semibold uppercase text-gray-500">
                        MS
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex items-center justify-center bg-gray-100 rounded-full w-16 h-16 text-lg font-semibold uppercase text-gray-500">
                        MS
                      </div>
                      {/* End */}
                    </div>
