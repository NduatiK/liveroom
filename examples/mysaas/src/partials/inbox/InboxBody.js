    ...
    >
      ...
      <div className="flex-grow px-4 sm:px-6 md:px-5 py-4">
        ...
        <header className="sm:flex sm:items-start sm:justify-between mb-4">
          <h1 className="text-xl leading-snug text-gray-800 font-bold mb-1 sm:mb-0 ml-2">
            Chill your mind with this amazing offer 🎉
          </h1>
          <button className="text-xs inline-flex font-medium bg-light-blue-100 text-light-blue-600 rounded-full text-center px-2.5 py-1 whitespace-nowrap">
            Exciting news
          </button>
        </header>
