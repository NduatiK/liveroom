  ...
  return (
    <div className="flex justify-center">
      <nav className="flex" role="navigation" aria-label="Navigation">
        <div className="mr-2">
          <span className="inline-flex items-center justify-center border border-transparent rounded leading-5 px-2.5 py-2 bg-white border-gray-200 text-gray-300">
        ...
        <ul className="inline-flex text-sm font-medium -space-x-px shadow-sm">
          ...
          <li>
            <span className="inline-flex items-center justify-center border border-transparent leading-5 px-3.5 py-2 bg-white border-gray-200 text-gray-400">
              …
            </span>
          </li>
          <li>
