                    ...
                    <div>
                      ...
                      <form>
                        ...
                        <div className="relative">
                          ...
                          <div className="absolute inset-0 right-auto flex items-center pointer-events-none">
                            <svg
                              className="w-4 h-4 fill-current text-gray-400 flex-shrink-0 ml-3 mr-2"
                              viewBox="0 0 16 16"
                            >
                  ...
                  <div className="flex flex-wrap items-center -m-3">
                    ...
                    <div className="m-3">
                      ...
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          className="form-checkbox disabled:bg-gray-50"
                          disabled
                        />
                    ...
                    <div className="m-3">
                      ...
                      <label className="flex items-center">
                        <input
                          type="radio"
                          name="radio-buttons"
                          className="form-radio disabled:bg-gray-50"
                          disabled
                        />
                        <span className="text-sm ml-2">Disabled</span>
                      </label>
