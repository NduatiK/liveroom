  ...
  return (
    <div className="flex-grow px-4 sm:px-6 md:px-5 py-6">
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        />
        <div>
          <div className="text-sm bg-white text-gray-800 p-3 rounded-lg rounded-tl-none border border-gray-200 shadow-md mb-1">
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <div className="text-xs text-gray-500 font-medium">2:40 PM</div>
            <svg
              className="w-5 h-3 flex-shrink-0 fill-current text-green-500"
              viewBox="0 0 20 12"
            >
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <svg
              className="w-3 h-3 flex-shrink-0 fill-current text-gray-400"
              viewBox="0 0 12 12"
            >
