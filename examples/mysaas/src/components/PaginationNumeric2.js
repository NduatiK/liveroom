      ...
      >
        ...
        <div className="flex-grow text-center">
          <ul className="inline-flex text-sm font-medium -space-x-px">
            ...
            <li>
              <a
                className="inline-flex items-center justify-center leading-5 px-2 py-2 text-gray-600 hover:text-indigo-500 border border-transparent"
                href="#0"
              >
            ...
            <li>
              <a
                className="inline-flex items-center justify-center rounded-r leading-5 px-2 py-2 text-gray-600 hover:text-indigo-500 border border-transparent"
                href="#0"
              >
