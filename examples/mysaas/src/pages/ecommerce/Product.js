              ...
              <div>
                ...
                <div className="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                  ...
                  <div className="flex items-center sm:mr-4">
                    ...
                    <a
                      className="block text-sm font-semibold text-gray-800 whitespace-nowrap"
                      href="#0"
                    >
                      Simona Lürwer
                    </a>
                ...
                {/* Product content */}
                <div>
                  <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">
                    Overview
                  </h2>
                  <p className="mb-6">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                ...
                <div>
                  ...
                  <ul className="space-y-8 sm:space-y-5 my-6">
                    ...
                    <li className="sm:flex items-center">
                      <a
                        className="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto flex-shrink-0"
                        href="#0"
                      >
                        <img
