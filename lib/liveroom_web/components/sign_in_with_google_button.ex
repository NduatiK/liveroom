defmodule LiveroomWeb.Components.SignInWithGoogleButton do
  ...
  def render(assigns) do
    ...
    <div style="display:flex; flex-direction:column; width:368px; margin-left:133px;">
      <a
        ...
        style="display:inline-flex; align-items:center; min-height:50px; background-color:#4285F4; font-size:28px; color:white; text-decoration:none; margin-top: 12px"
      >
