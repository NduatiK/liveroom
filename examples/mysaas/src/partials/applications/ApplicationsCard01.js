        ...
        <div className="flex-grow flex flex-col p-5">
          ...
          <div className="flex-grow">
            ...
            <div className="flex items-center space-x-2 mb-4">
              ...
              {/* Rate */}
              <div className="inline-flex text-sm font-medium bg-yellow-100 text-yellow-600 rounded-full text-center px-2.5 py-0.5">
                {props.rating}
              </div>
            </div>
            {/* Features list */}
            <ul className="text-sm space-y-2 mb-5">
              {props.feat01 && (
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 fill-current text-gray-400 flex-shrink-0 mr-3"
                    viewBox="0 0 16 16"
                  >
