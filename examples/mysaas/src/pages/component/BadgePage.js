              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-xs inline-flex font-medium bg-gray-700 text-gray-100 rounded-full text-center px-2.5 py-1">
                        All Stories
                      </div>
                      {/* End */}
                    </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-light-blue-100 text-light-blue-600 rounded-full text-center px-2.5 py-1">
                        Exciting news
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-green-100 text-green-600 rounded-full text-center px-2.5 py-1">
                        Product
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-yellow-100 text-yellow-600 rounded-full text-center px-2.5 py-1">
                        Announcement
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-red-100 text-red-600 rounded-full text-center px-2.5 py-1">
                        Bug Fix
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-gray-100 text-gray-500 rounded-full text-center px-2.5 py-1">
                        All Stories
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-gray-700 text-gray-100 rounded-full text-center px-2.5 py-1">
                        All Stories
                      </div>
                      {/* End */}
                    </div>
