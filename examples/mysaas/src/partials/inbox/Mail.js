...
function Mail(props) {
  ...
  return (
    <div className="py-6">
        ...
        <div className="flex-grow">
          <div className="sm:flex items-start justify-between mb-0.5">
            ...
            <div className="xl:flex items-center mb-2 sm:mb-0">
              <button
                className="text-sm font-semibold text-gray-800 text-left truncate"
              ...
              {open && (
                <>
                  <div className="text-sm text-gray-400 hidden xl:block mx-1">
                    ·
                  </div>
      ...
      {open && (
        <div
          className="text-sm text-gray-800 mt-4 space-y-2"
